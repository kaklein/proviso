            ...
            <section class="login-clean" style="opacity: 1;background: rgba(252,242,241,0);">
                <form action="${pageContext.request.contextPath}/hotel/ProvisoServlet" method="post" style="opacity: 1;filter: blur(0px) brightness(100%) grayscale(0%) hue-rotate(0deg) invert(0%) sepia(0%);">
                    ...
                    <div class="mb-3">
                   	...
                   	<a class="text-center d-block w-100 text-decoration-none" href="${pageContext.request.contextPath}/jsp/Registration.jsp" style="color: var(--bs-white);opacity: 1;text-align: center;font-weight: bold;font-size: 16px;">Not a Member?  Sign Up!<br /></a>
                </form>
            </section>
        </div>
    </main>
